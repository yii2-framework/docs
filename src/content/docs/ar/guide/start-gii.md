---
title: '<div dir="rtl">إنشاء الشيفرة البرمجية من خلال ال gii</div>'
---
...
![Model Generator](/docs/guide/images/start-gii-model.png)
...
![Model Generator Preview](/docs/guide/images/start-gii-model-preview.png)
...
![CRUD Generator](/docs/guide/images/start-gii-crud.png)

<p dir="rtl">
    بعد ذلك، قم بالنقر على زر ال "Preivew"، وستشاهد قائمة بالملفات التي سيتم إنشائها كما في الصورة أدناه.
</p>

![CRUD Generator Preview](/docs/guide/images/start-gii-crud-preview.png)
...
![Data Grid of Countries](/docs/guide/images/start-gii-country-grid.png)

![Updating a Country](/docs/guide/images/start-gii-country-update.png)
