...
許可は他の許可を含むことが出来ます。Yii は、一般的な _半順序_ 階層を実装していますが、これはその特殊形として _木_ 階層を含むものです。
...
![単純な RBAC 階層](/docs/guide/images/rbac-hierarchy-1.png "単純な RBAC 階層")
...
![規則を持つ RBAC 階層](/docs/guide/images/rbac-hierarchy-2.png "規則を持つ RBAC 階層")
...
![アクセス・チェック](/docs/guide/images/rbac-access-check-1.png "アクセス・チェック")
...
![アクセス・チェック](/docs/guide/images/rbac-access-check-2.png "アクセス・チェック")
...
![アクセス・チェック](/docs/guide/images/rbac-access-check-3.png "アクセス・チェック")
...
デフォルト・ロールというのは、_全て_ のユーザに _黙示的_ に割り当てられるロールです。
