---
title: "アプリケーション・コンポーネント"
---


アプリケーションは [サービス・ロケータ](concept-service-locator.md) です。
アプリケーションは、リクエストを処理するためのいろいろなサービスを提供する一組の _アプリケーション・コンポーネント_ と呼ばれるものをホストします。
...
Yii は固定の ID とデフォルトの構成情報を持つ一連の _コア_・アプリケーション・コンポーネントを定義しています。
