...
![Model Generator のプレビュー](/docs/guide/images/start-gii-model-preview.png)
...
![CRUD Generator のプレビュー](/docs/guide/images/start-gii-crud-preview.png)
...
![国リストのデータ・グリッド](/docs/guide/images/start-gii-country-grid.png)

![国データを更新する](/docs/guide/images/start-gii-country-update.png)
