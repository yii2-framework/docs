...
![Статична структура додатка](/docs/guide/images/application-structure.png)
...
![Життєвий цикл запиту](/docs/guide/images/request-lifecycle.png)
