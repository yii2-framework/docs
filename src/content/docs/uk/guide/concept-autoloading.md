...
який встановлюється в момент підключення файлу `vendor/autoload.php`.
...
Автозавантажувач Yii підтримує _мапу класів_. Ця можливість дозволяє вказати шлях до файлу для кожного імені класу.
...
Ви маєте можливість додати клас в мапу Composer classmap наступним чином:
...
При використанні додаткових автозавантажувачів, файл `vendor/autoload.php` повинен бути підключений _після_ їх установки.
...
Перший рядок встановлює автозавантажувач Composer, а другий - автозавантажувач Composer:
...
> Info: Якщо ви не хочете використовувати автозавантажувач Composer, створіть свою версію файлу `vendor/autoload.php`
...
Якщо ви не використовуєте автозавантажувач Composer, то класи розширень можуть бути автоматично завантажені з допомогою автозавантажувач Composer.
