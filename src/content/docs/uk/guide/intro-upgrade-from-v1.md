...
поточному контролеру або віджету. Замість цього, `$this` тепер відповідає обʼєкту _представлення_, новій можливості,
яка була введена у версії 2.0. Обʼєкт представлення має тип [[yii\web\View]], який являє собою частину _представлення_
...
У Yii 2.0 представлена нова можливість _колекції ресурсів_, яка замінює концепт пакунків скриптів у Yii 1.1.
...
Yii 2.0 вводить нове поняття _поле_ для побудови форм за допомогою [[yii\widgets\ActiveForm]]. Поле - це
