...
Дана подія виникає _до_ того, як додаток починає обробляти вхідний запит. Справжнє ім’я події - `beforeRequest`.
...
Дана подія виникає _після_ закінчення обробки запиту додатком, але _до_ відправлення відповіді.
...
користувачу. Ці події виникають _після_ поточної події.

### [[yii\base\Application::EVENT_BEFORE_ACTION|EVENT_BEFORE_ACTION]] <span id="beforeAction"></span>

Подія виникає _до_ виконання кожної [дії контролера](structure-controllers.md).
...
Ця подія виникає _після_ виконання кожної [дії контролера](structure-controllers.md).
...
![Життєвий цикл додатка](/docs/guide/images/application-lifecycle.png)
