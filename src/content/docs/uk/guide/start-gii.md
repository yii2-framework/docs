---
title: "Генерування коду за допомогою Gii"
---
...
![Генератор моделі](/docs/guide/images/start-gii-model.png)
...
![Генератор моделі: попередній перегляд](/docs/guide/images/start-gii-model-preview.png)
...
![Генератор CRUD](/docs/guide/images/start-gii-crud.png)

Далі, натисніть на кнопку "Перегляду" ("Preview"). Ви побачите список файлів, які будуть створені, як показано нижче.

![Генератор CRUD: попередній перегляд](/docs/guide/images/start-gii-crud-preview.png)
...
![Таблиця даних країн](/docs/guide/images/start-gii-country-grid.png)

![Оновлення даних країни](/docs/guide/images/start-gii-country-update.png)
