...
> Info: Клас [[yii\base\Model]] використовується як батьківський клас для класів моделей, які _не_ асоційовані з таблицями бази даних.
...
![Форма з помилками перевірки](/docs/guide/images/start-form-validation.png)

Після введення вірних даних і їх відправлення, ви побачите нову сторінку з даними, які щойно вказали.

![Підтвердження введених даних](/docs/guide/images/start-entry-confirmation.png)
