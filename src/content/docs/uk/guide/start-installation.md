...
У цьому та у наступних кількох розділах буде описано, як встановити Yii з так званим _Базовим шаблоном проекту_ та
...
![Успішно встановлений Yii](/docs/guide/images/start-app-installed.png)
