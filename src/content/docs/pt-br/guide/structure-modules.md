...
de configurações de módulos. Cada chave do array representa um _ID do módulo_
...
de _módulo parente_ enquanto os próximos de _módulo filho_. Os módulos filhos devem
