...
O cache de dados se baseia nos, então chamados, _Componentes de Cache_ que representam vários armazenamentos de cache,
...
_dependências de cache_. Por exemplo, [[yii\caching\FileDependency]] representa a dependência na data de modificação
de um arquivo.
