...
![Gerador de Modelo](/docs/guide/images/start-gii-model.png)
...
![Pré-visualização do Gerador de Modelo](/docs/guide/images/start-gii-model-preview.png)
...
![Gerador de CRUD](/docs/guide/images/start-gii-crud.png)

Em seguida, clique no botão "Preview". Você verá uma lista de arquivos a serem gerados, como mostrado abaixo.

![Pré-visualização do Gerador de CRUD](/docs/guide/images/start-gii-crud-preview.png)
...
![Grade de Países](/docs/guide/images/start-gii-country-grid.png)

![Editando um País](/docs/guide/images/start-gii-country-update.png)
