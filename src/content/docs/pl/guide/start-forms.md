...
> Info: [[yii\base\Model|Model]] jest używane jako rodzic dla klasy modeli _NIE_ powiązanych z tabelą bazy danych.
...
![Formularz z błędami walidacji](/docs/guide/images/start-form-validation.png)
...
![Potwierdzenie](/docs/guide/images/start-entry-confirmation.png)
