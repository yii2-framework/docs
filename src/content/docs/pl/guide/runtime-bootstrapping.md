...
Ponieważ proces bootstrappingu jest wykonywany przed obsługą _każdego_ żądania, niezwykle istotnym jest, aby był lekki i zoptymalizowany tak bardzo, jak to tylko możliwe.
