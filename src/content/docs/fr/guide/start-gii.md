...
![Générateur de Modèles](/docs/guide/images/start-gii-model.png)
...
![Prévisualisation du générateur de modèle](/docs/guide/images/start-gii-model-preview.png)
...
![Grille de Données Pays](/docs/guide/images/start-gii-country-grid.png)

![Mettre à Jour un Pays](/docs/guide/images/start-gii-country-update.png)
