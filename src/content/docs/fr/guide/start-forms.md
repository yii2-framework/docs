...
> Info: [[yii\base\Model]] est utilisée en tant que parent pour des classes modèles qui ne sont _pas_ associées à des
...
![Formulaire Comportant des Erreurs de Validation](/docs/guide/images/start-form-validation.png)
...
![Confirmation de la Saisie de Données](/docs/guide/images/start-entry-confirmation.png)
