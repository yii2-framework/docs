...
La mise en cache s'appuie sur ce qu'on appelle les _composants de mise en cache_ qui représentent des supports de mise en cache tels que les mémoires, les fichiers et les bases de données.
...
En plus de la définition du temps d'expiration, les données mises en cache peuvent également être invalidées par modification de ce qu'on appelle les _dépendances de mise en cache_.
