...
![Sinh Model](/docs/guide/images/start-gii-model.png)
...
![Xem CRUD Generator](/docs/guide/images/start-gii-crud-preview.png)
...
![Bảng Countries](/docs/guide/images/start-gii-country-grid.png)

![Cập nhật Country](/docs/guide/images/start-gii-country-update.png)
