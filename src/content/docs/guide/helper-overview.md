...
Next, in your application's `composer.json`, add the following autoload configuration
to load your custom class instead of the original helper class from the framework:
