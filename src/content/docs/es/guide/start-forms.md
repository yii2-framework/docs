...
![Formulario con Errores de Validación](/docs/guide/images/start-form-validation.png)
...
![Confirmación de los Datos de Entrada](/docs/guide/images/start-entry-confirmation.png)
