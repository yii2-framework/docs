...
> código de estado 302 que indica al navegador que recurso solicitado está _temporalmente_ alojado en una URI diferente.
> Se puede enviar un código de estado 301 para expresar que el recurso se ha movido de forma _permanente_.
...
> fichero JavaScript (registrándolo _asset bundle_ [[yii\web\YiiAsset]]), no se necesitará escribir nada más para tener
...
- [[yii\web\Response::sendStreamAsFile()]]: envía un _file stream_ existente al cliente como si fuera un archivo.
...
Algunos servidores Web tienen un soporte especial para enviar ficheros llamado _X-Sendfile_. La idea es redireccionar
