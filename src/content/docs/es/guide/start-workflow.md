...
![Estructura Estática de una Aplicación](/docs/guide/images/application-structure.png)
...
![Ciclo de Vida de un Request](/docs/guide/images/request-lifecycle.png)
