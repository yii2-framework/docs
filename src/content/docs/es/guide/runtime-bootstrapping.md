...
Debido a que el trabajo de bootstrapping se tiene que ejecutar antes de gestionar _todas_ las peticiones, es muy importante mantener este proceso ligero y optimizado lo máximo que sea posible.
