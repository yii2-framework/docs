...
![Previsualización del Model Generator](/docs/guide/images/start-gii-model-preview.png)
...
![Generador de ABM](/docs/guide/images/start-gii-crud.png)
...
![Grilla de Países](/docs/guide/images/start-gii-country-grid.png)

![Actualizando un País](/docs/guide/images/start-gii-country-update.png)
