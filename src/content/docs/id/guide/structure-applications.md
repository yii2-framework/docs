...
_Event_ ini dijalankan _sebelum_ objek aplikasi menangani sebuah _request_. Nama _event_-nya adalah `beforeRequest`.
...
_Event_ ini dijalankan _setelah_ objek aplikasi menyelesaikan penanganan sebuah _request_ tetapi _sebelum_ mengirimkan _response_.
...
isi _response_ ke pengguna. _Event_ tersebut akan dijalankan _setelah_ _event_ ini.

### [[yii\base\Application::EVENT_BEFORE_ACTION|EVENT_BEFORE_ACTION]] <span id="beforeAction"></span>

_Event_ ini dijalankan _sebelum_ semua [action dari controller](structure-controllers.md) diproses.
...
_Event_ ini dijalankan _setelah_ menjalankan seluruh [action dari controller](structure-controllers.md).
...
![Siklus Aplikasi](/docs/guide/images/application-lifecycle.png)
