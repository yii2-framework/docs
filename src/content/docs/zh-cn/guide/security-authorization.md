...
![Simple RBAC hierarchy](/docs/guide/images/rbac-hierarchy-1.png "简单的 RBAC 层次结构示意图")
...
![RBAC hierarchy with a rule](/docs/guide/images/rbac-hierarchy-2.png "有一个规则的 RBAC 层次结构")
...
![Access check](/docs/guide/images/rbac-access-check-2.png "存取权限检查")
