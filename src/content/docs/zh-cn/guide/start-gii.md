...
![模型生成器](/docs/guide/images/start-gii-model.png)
...
![模型生成器预览](/docs/guide/images/start-gii-model-preview.png)
...
![CRUD 生成器](/docs/guide/images/start-gii-crud.png)

然后点击 “Preview” 按钮。你会看到下述将要生成的文件列表。

![CRUD 生成器预览](/docs/guide/images/start-gii-crud-preview.png)
...
![国家的数据栅格](/docs/guide/images/start-gii-country-grid.png)

![编辑一个国家](/docs/guide/images/start-gii-country-update.png)
