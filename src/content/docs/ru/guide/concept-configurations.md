...
_конфигурационными файлами_. Конфигурационный файл возвращает массив PHP, являющийся конфигурацией.
