...
представляет собой _идентификатор модуля_, который однозначно определяет модуль среди других модулей приложения,
...
входит еще один модуль, и т. д. Первый модуль называется _родительским_, остальные - _дочерними_. Дочерние модули
