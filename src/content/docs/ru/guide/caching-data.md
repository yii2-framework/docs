...
Кэширование данных опирается на _компоненты кэширования_, которые представляют различные хранилища, такие как память, файлы и базы данных.
