...
автозагрузчик, который устанавливается в момент подключения `vendor/autoload.php`.
...
## Как использовать автозагрузчик Composer <span id="using-yii-autoloader"></span>
...
Автозагрузчик Yii поддерживает _карту классов_. Эта возможность позволяет указать путь к файлу для каждого имени класса.
...
Вы можете добавить класс в карту Composer classmap следующим образом:
...
При использовании дополнительных автозагрузчиков файл `vendor/autoload.php` должен быть подключен _после_ их установки. Это позволит
...
автозагрузчик Composer, а вторая — автозагрузчик Composer:
...
> Info: Если вы не хотите использовать автозагрузчик Composer, создайте свою версию файла `vendor/autoload.php`
...
Если вы не используете автозагрузчик Composer, то классы расширений могут быть автоматически загружены с помощью
