...
> Note: псевдоним пути к файлу или URL _не_ обязательно указывает на существующий файл или ресурс.
...
[[Yii::setAlias()]], являются _корневыми псевдонимами_, в то время как полученные из них называются _производными
псевдонимами_. К примеру, `@foo` является корневым псевдонимом, а `@foo/bar/file.php` — производным.
