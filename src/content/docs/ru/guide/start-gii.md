---
title: "Генерация кода при помощи Gii"
---
...
![Генератор модели](/docs/guide/images/start-gii-model.png)
...
![Предварительный просмотр генератора модели](/docs/guide/images/start-gii-model-preview.png)
...
![CRUD генератор](/docs/guide/images/start-gii-crud.png)

Затем нажмите на кнопку "Preview". Вы увидите список файлов, которые будут созданы, как показано ниже.

![CRUD генератор: предпросмотр](/docs/guide/images/start-gii-crud-preview.png)
...
![Таблица данных стран](/docs/guide/images/start-gii-country-grid.png)

![Обновление страны](/docs/guide/images/start-gii-country-update.png)
