...
_компонентов приложения_, которые предоставляют различные средства для обработки запросов. Например,
...
В Yii есть несколько _встроенных_ компонентов приложения, с фиксированными ID и конфигурациями по умолчанию. Например,
