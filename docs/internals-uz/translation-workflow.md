...
3. `uz` dagi tarjimalar bilan [pull request qilamiz](https://github.com/yiisoft/yii2/blob/master/docs/internals/git-workflow.md), qolgan tillarga tegmaymiz.
...
- to parse — qayta ishlash, agar _kontekst_ tushunarsiz bo'lsa _parsing_ qilish.
- placeholder — marker.
- production (mode) — ishlab chiqarish (rejimi) (см. debug mode).
- property — xususiyati (obekt).
- to render — _render_ qilish, formallashtirish.
