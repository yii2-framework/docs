...
Toutes les méthodes de construction de requêtes retournent l'objet _query_ lui-même, ce qui vous permet d'enchaîner plusieurs appels.
...
est générée à partir de l'objet _query_ (requête).
...
ce qui signifie la sélection de _toutes_ les colonnes.
