...
the code that does it for us. The code that verifies the result matches what we've planned is called _test_ and
the process of its creation and further execution is known as _automated testing_, which is the main topic of these
testing chapters.
