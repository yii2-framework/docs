...
_application components_ that provide different services for processing requests. For example,
...
Yii defines a set of _core_ application components with fixed IDs and default configurations. For example,
