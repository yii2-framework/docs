...
поведения. В таком случае, поведение называется _именованным_. В примере выше,
...
Вы можете обращаться к _публичным_ переменным или [свойствам](concept-properties.md), объявленным с использованием
...
Аналогично, вы можете вызывать _публичные_ методы поведения:
...
Так же, возможно отвязать _все_ поведения:
