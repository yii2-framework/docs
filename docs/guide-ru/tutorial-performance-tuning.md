...
Кэширование схемы - это специальный _тип кеширования_, который должен быть включен при использовании [Active Record](db-active-record.md).
...
хранилища кеша могут _сбрасывать_ закешированные данные при достижении лимитов хранилища. По этой причине, вы должны в
...
Хотя использование техник [кэширования данных](caching-data.md) может _смягчить_ снижение производительности, оно не
