...
> Note: псевдонім шляху до файлу або URL _не_ обовʼязково вказує на наявний файл або ресурс.
...
[[Yii::setAlias()]], є _кореневими псевдонімами_, в той час як отримані з них називаються _похідними псевдонімами_.
