...
Un filtro puede consistir en un pre-filtro (lógica de filtrado aplicada _antes_ de las acciones) y/o un post-filtro
(lógica de filtro aplicada _después_ de las acciones).
...
Por defecto, los filtros declarados en una clase controlador, serán aplicados en _todas_ las acciones de este
...
Una vez hecho, los filtros serán aplicados a _todas_ las acciones de controlador que pertenezcan a ese modulo o
