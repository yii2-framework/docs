...
Los modelos representan los datos de negocio en términos de _atributos_. Cada atributos es como una propiedad
...
Un modelo puede usarse en diferentes _escenarios_. Por ejemplo, un modelo 'Usuario', puede ser utilizado para recoger
...
_atributos activos_. Un atributo activo puede ser [asignado masivamente](#massive-assignment) y esta sujeto a
...
(llamadas _reglas de validación_, también conocidas como _reglas de negocio_). Por ejemplo, dado un modelo
...
_regla activa_ si esta puede aplicarse en el [[yii\base\Model::scenario|scenario]] actual.
...
La asignación masiva sólo se aplica a los llamados _atributos seguros_ qué son los atributos listados en
...
Por defecto, la propiedad [[yii\base\Model::$attributes]] devolverá los valores de _todos_ los atributos declarados en
...
elementos de datos, llamados _campos_, queremos poner en el array resultante y elegir como debe ser formateado. De
