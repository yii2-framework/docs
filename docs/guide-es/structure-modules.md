...
array representa un _ID de módulo_ que identifica de forma única el módulo de entre todos los módulos de la
...
contener otro módulo. Nombramos _padre_ al primero mientras que al segundo lo nombramos _hijo_. Los módulos hijo se
